 ...
 * @see {@link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-transfer-server.html | AWS::Transfer::Server}
 */
export class TransferServer extends ResourceBase<
  "AWS::Transfer::Server",
  TransferServerProps,
  TransferServerAttribs
> {
  public static readonly Type = "AWS::Transfer::Server";
  public static readonly AttributeNames: readonly (keyof TransferServerAttribs)[] =
    ["ServerId", "Arn"];
  constructor(
    logicalId: string,
    properties: TransferServerProps,
    options?: ResourceOptions,
  ) {
    super(
      TransferServer.Type,
